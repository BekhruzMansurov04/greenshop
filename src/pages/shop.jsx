...
const Shop = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const res = await axios.get(
        `https://green-shop-backend.onrender.com/api/user/blog?access_token=6803b89df2a99d0247959d1a&search=${search}`
      );
  ...
  if (!blogs || blogs.length === 0)
    return <div className="text-center p-4">Blog topilmadi</div>;
