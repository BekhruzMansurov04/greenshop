...
import { FaSearch, FaShoppingCart, FaSignInAlt, FaBell } from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white border-b border-gray-200 shadow-sm py-3 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div
          ...
          onClick={() => navigate("/")}
        >
          <img src="/nature.png" alt="Logo" className="w-8 h-8" />
